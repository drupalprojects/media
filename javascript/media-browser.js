...
Drupal.media.browser.validateButtons = function() {
  ...
  $('a.button.fake-ok').not('.processed').bind('click', Drupal.media.browser.submit).addClass('processed');
  $('a.button.fake-cancel').not('.processed').bind('click', Drupal.media.browser.submit).addClass('processed');
